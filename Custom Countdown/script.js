...
// // Set Date Input Min with Todday's Date
...
//         // it the countdown has ended, show complete
//      if (distance <0) {
...
//        countdownElTitle.textContent.content = `${countdownTitle}`;
...
//    if (countdownDate === '') {
//     alert('please celect a date for the countdown.');
//    } else {
